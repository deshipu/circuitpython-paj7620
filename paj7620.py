...
_ADDR = (b'\xefAB789BFGHIJLQ^`\x80\x81\x82\x8b\x90\x95\x96\x97\x9a\x9c'
         b'\xa5\xcc\xcd\xce\xcf\xd0\xef\x02\x03\x04%\'()>^egijmnrstw\xef'
         b'AB')
_DATA = (b'\x00\x00\x00\x07\x17\x06\x01-\x0f<\x00\x1e"\x10\x10\'BD\x04'
